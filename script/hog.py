...
hog2=ft.hog(img2, orientations=10, pixels_per_cell=(8, 8), cells_per_block=(3, 3), block_norm='L2-Hys', visualize=True, transform_sqrt=False, feature_vector=True, multichannel=None)
print(len(hog1[0]), len(hog2[0]))
